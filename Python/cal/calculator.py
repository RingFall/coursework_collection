...
class Calculator(object):
	...
	def __init__(self):
		...
		self.midstr=''
		self.ans='0'
		self.ButtonList=['清空','/','*','退格',7,8,9,'-',4,5,6,'+',1,2,3,0,'.','=','1/x','%','sqrt','(',')','ans']
		#增加菜单
		...
		self.NumButton=tkinter.Button(master=self.tk,relief=GROOVE,bg='#C6E2FF',text=self.ButtonList[18],
			font=self.ButtonFont,command=lambda:self.knobDown(self.ButtonList[18]))
		self.NumButton.place(x=30,y=380,width=70,height=55)
		self.NumButton=tkinter.Button(master=self.tk,relief=GROOVE,bg='#C6E2FF',text=self.ButtonList[19],
			font=self.ButtonFont,command=lambda:self.knobDown(self.ButtonList[19]))
		self.NumButton.place(x=110,y=380,width=70,height=55)
		self.NumButton=tkinter.Button(master=self.tk,relief=GROOVE,bg='#C6E2FF',text=self.ButtonList[20],
			font=self.ButtonFont,command=lambda:self.knobDown(self.ButtonList[20]))
		self.NumButton.place(x=190,y=380,width=70,height=55)
		self.NumButton=tkinter.Button(master=self.tk,relief=GROOVE,bg='#C6E2FF',text=self.ButtonList[21],
			font=self.ButtonFont,command=lambda:self.knobDown(self.ButtonList[21]))
		self.NumButton.place(x=30,y=440,width=70,height=55)
		self.NumButton=tkinter.Button(master=self.tk,relief=GROOVE,bg='#C6E2FF',text=self.ButtonList[22],
			font=self.ButtonFont,command=lambda:self.knobDown(self.ButtonList[22]))
		self.NumButton.place(x=110,y=440,width=70,height=55)
		self.NumButton=tkinter.Button(master=self.tk,relief=GROOVE,bg='#C6E2FF',text=self.ButtonList[23],
			font=self.ButtonFont,command=lambda:self.knobDown(self.ButtonList[23]))
		self.NumButton.place(x=190,y=440,width=70,height=55)
	
	#关于
	def about(self):
		messagebox.showinfo('关于', ' 作者：RingFa1l \n verion 1.0 \n 感谢您的使用！')
